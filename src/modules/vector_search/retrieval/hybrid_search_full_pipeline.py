...
from src.architectures.hybrid_rag import QdrantHybridRAG
...
collection_name = "hybrid_documents_full"
...
rag = QdrantHybridRAG(client=client, collection_name=collection_name, dense_model=dense_model, sparse_model=splade_model, llm=llm)
