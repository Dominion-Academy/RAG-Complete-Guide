...
sparse_model = FastEmbedSparseEmbeddingsModel(model_name="prithivida/Splade_PP_en_v1")
doc_embeddings = sparse_model.embed_document(texts)
...
# 4. Создаем коллекцию
collection_name = "splade_documents"
...
query_embedding = sparse_model.embed_query(query)
